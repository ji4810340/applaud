...
class AppStoreVersionExperimentsOfAppStoreVersionEndpoint(IDEndpoint):
    ...
    def filter(self, *, state: Union[AppStoreVersionState, list[AppStoreVersionState]]=None) -> AppStoreVersionExperimentsOfAppStoreVersionEndpoint:
...
class AppStoreVersionExperimentsV2OfAppStoreVersionEndpoint(IDEndpoint):
    ...
    def filter(self, *, state: Union[AppStoreVersionState, list[AppStoreVersionState]]=None) -> AppStoreVersionExperimentsV2OfAppStoreVersionEndpoint:
        '''Attributes, relationships, and IDs by which to filter.
...
class AppStoreVersionLocalizationsOfAppStoreVersionEndpoint(IDEndpoint):
    ...
    def fields(self, *, app_store_version_localization: Union[AppStoreVersionLocalizationField, list[AppStoreVersionLocalizationField]]=None, app_store_version: Union[AppStoreVersionField, list[AppStoreVersionField]]=None, app_screenshot_set: Union[AppScreenshotSetField, list[AppScreenshotSetField]]=None, app_preview_set: Union[AppPreviewSetField, list[AppPreviewSetField]]=None) -> AppStoreVersionLocalizationsOfAppStoreVersionEndpoint:
        '''Fields to return for included related types.
    ...
    def limit(self, number: int=None, *, app_screenshot_sets: int=None, app_preview_sets: int=None) -> AppStoreVersionLocalizationsOfAppStoreVersionEndpoint:
        '''Number of resources or included related resources to return.
