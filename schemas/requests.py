...
class AgeRatingDeclarationUpdateRequest(ApplaudRequest):
    class Data(ApplaudModel):
        class Attributes(ApplaudModel):
            ...
            alcohol_tobacco_or_drug_use_or_references: Literal[AlcoholTobaccoOrDrugUseOrReferences.NONE] = AlcoholTobaccoOrDrugUseOrReferences.NONE
            contests: Literal[Contests.NONE] = Contests.NONE
            gambling: Optional[bool]
            gambling_simulated: Literal[GamblingSimulated.NONE] = GamblingSimulated.NONE
            kids_age_band: Optional[KidsAgeBand]
            loot_box: Optional[bool]
            medical_or_treatment_information: Literal[MedicalOrTreatmentInformation.NONE] = MedicalOrTreatmentInformation.NONE
            profanity_or_crude_humor: Literal[ProfanityOrCrudeHumor.NONE] = ProfanityOrCrudeHumor.NONE
            sexual_content_graphic_and_nudity: Literal[SexualContentGraphicAndNudity.NONE] = SexualContentGraphicAndNudity.NONE
            sexual_content_or_nudity: Literal[SexualContentOrNudity.NONE] = SexualContentOrNudity.NONE
            horror_or_fear_themes: Literal[HorrorOrFearThemes.NONE] = HorrorOrFearThemes.NONE
            mature_or_suggestive_themes: Literal[MatureOrSuggestiveThemes.NONE] = MatureOrSuggestiveThemes.NONE
            unrestricted_web_access: Optional[bool]
            violence_cartoon_or_fantasy: Literal[ViolenceCartoonOrFantasy.NONE] = ViolenceCartoonOrFantasy.NONE
            violence_realistic_prolonged_graphic_or_sadistic: Literal[ViolenceRealisticProlongedGraphicOrSadistic.NONE] = ViolenceRealisticProlongedGraphicOrSadistic.NONE
            violence_realistic: Literal[ViolenceRealistic.NONE] = ViolenceRealistic.NONE
