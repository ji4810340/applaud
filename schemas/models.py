...
class AgeRatingDeclaration(ApplaudModel):
    class Attributes(ApplaudModel):
        ...
        alcohol_tobacco_or_drug_use_or_references: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
        contests: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
        gambling: Optional[bool]
        gambling_simulated: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
        kids_age_band: Optional[KidsAgeBand]
        loot_box: Optional[bool]
        medical_or_treatment_information: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
        profanity_or_crude_humor: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
        sexual_content_graphic_and_nudity: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
        sexual_content_or_nudity: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
        horror_or_fear_themes: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
        mature_or_suggestive_themes: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
        unrestricted_web_access: Optional[bool]
        violence_cartoon_or_fantasy: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
        violence_realistic_prolonged_graphic_or_sadistic: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
        violence_realistic: Literal[AgeRatingDeclarationLevel.NONE] = AgeRatingDeclarationLevel.NONE
...
class GameCenterChallenge(ApplaudModel):
    class Attributes(ApplaudModel):
        ...
        reference_name: Optional[str]
        vendor_identifier: Optional[str]
        allowed_durations: Optional[list[str]]
        archived: Optional[bool]
...
class GameCenterMatchmakingRuleSetTest(ApplaudModel):
    class Attributes(ApplaudModel):
        matchmaking_results: Optional[list[list[object]]]
